...
# CRITICAL: Set these BEFORE any other imports to avoid FakeTensorMode error
os.environ["VLLM_COMPILE"] = "0"  # Disable vLLM torch.compile
...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name="unsloth/Qwen3-32B",  # Unsloth downloads its own optimized version
    max_seq_length=8192,
    load_in_4bit=True,               # 4-bit on H200 — uses ~20GB, leaves tons for training
    fast_inference=True,
    max_lora_rank=64,
