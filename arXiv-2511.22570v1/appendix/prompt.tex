\section{Prompt Templates}\label{apx:cot-prompt}

\subsection{Proof Generation Prompt}
\label{app:proof_generation}
...
\subsection{Proof Verification Prompt}
\label{app:proof_verification}
\begin{lstlisting}[frame=single]
## Instruction
...
\subsection{Meta-Verification Prompt}
\label{app:meta_verification}
...
\subsection{Proof Refinement Prompt}
